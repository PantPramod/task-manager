...
const AddComponent = ({ close, todo, type }: propTypes) => {
    ...
    return (
        <div className='z-50 w-[100vw] h-[100vh] border bg-transparent fixed flex items-center justify-center top-0'>
            <div className=' z-10 w-[70vw] h-[70vh] bg-slate-50 shadow rounded p-[20px] '>
                <AiOutlineClose
                    onClick={close}
                ...
                <button
                    onClick={() => addToList()}
                    className='bg-blue-600 text-white py-[7px] px-[24px] rounded ml-auto mr-auto block'>Add</button>
            </div>
        </div>
    )
}
